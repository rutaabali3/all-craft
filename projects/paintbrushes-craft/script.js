...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading PaintbrushesCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to PaintbrushesCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@paintbrushes-craft.com

Made with ❤️ by the PaintbrushesCraft team
`);
