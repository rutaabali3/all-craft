...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading DiariesAndPlannersCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to DiariesAndPlannersCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@diaries-and-planners-craft.com

Made with ❤️ by the DiariesAndPlannersCraft team
`);
