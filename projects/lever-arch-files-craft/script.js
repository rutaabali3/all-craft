...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading LeverArchFilesCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to LeverArchFilesCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@lever-arch-files-craft.com

Made with ❤️ by the LeverArchFilesCraft team
`);
