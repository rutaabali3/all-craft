...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading CorrectionFluidCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to CorrectionFluidCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@correction-fluid-craft.com

Made with ❤️ by the CorrectionFluidCraft team
`);
