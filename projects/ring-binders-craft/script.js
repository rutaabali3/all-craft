...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading RingBindersCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to RingBindersCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@ring-binders-craft.com

Made with ❤️ by the RingBindersCraft team
`);
