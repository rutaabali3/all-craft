...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading StampPadsCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to StampPadsCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@stamp-pads-craft.com

Made with ❤️ by the StampPadsCraft team
`);
