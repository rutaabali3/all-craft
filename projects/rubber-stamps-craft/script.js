...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading RubberStampsCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to RubberStampsCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@rubber-stamps-craft.com

Made with ❤️ by the RubberStampsCraft team
`);
