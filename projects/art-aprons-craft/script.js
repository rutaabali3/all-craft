...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading ArtApronsCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to ArtApronsCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@art-aprons-craft.com

Made with ❤️ by the ArtApronsCraft team
`);
