...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading LetterTraysCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to LetterTraysCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@letter-trays-craft.com

Made with ❤️ by the LetterTraysCraft team
`);
