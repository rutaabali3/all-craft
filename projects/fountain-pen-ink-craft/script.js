...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading FountainPenInkCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to FountainPenInkCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@fountain-pen-ink-craft.com

Made with ❤️ by the FountainPenInkCraft team
`);
