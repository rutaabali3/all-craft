...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading ModelingClayCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to ModelingClayCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@modeling-clay-craft.com

Made with ❤️ by the ModelingClayCraft team
`);
