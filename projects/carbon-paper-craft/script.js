...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading CarbonPaperCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to CarbonPaperCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@carbon-paper-craft.com

Made with ❤️ by the CarbonPaperCraft team
`);
