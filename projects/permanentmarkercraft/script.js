...
function addLoadingScreen() {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            ...
            <h4 style="color: var(--primary-color); font-family: var(--font-display);">Loading PermanentMarkerCraft...</h4>
        </div>
    `;
...
console.log(`
🎨 Welcome to PermanentMarkerCraft Website!
✨ Built with love using HTML, CSS, JavaScript & Bootstrap
🚀 Featuring smooth scrolling and animations
📧 Contact: info@permanentmarkercraft.com

Made with ❤️ by the PermanentMarkerCraft team
`);
